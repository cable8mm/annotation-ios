...
class LabelTableViewController: UITableViewController, UITextViewDelegate,
  UIGestureRecognizerDelegate
{
  ...
  override func viewDidLoad() {
    ...
    AF.request(
      K.API_SERVER_PREFIX + "os_picture_labels/index_compact.json?os_picture_type_id="
    ...
    -> UITableViewCell
  {
    ...
    // Configure the cell...
    cell.textLabel?.text =
      self.osAllRawLabels[indexPath.section]["values"][indexPath.row]["name"].stringValue
  ...
  @IBAction func selectSection(_ sender: UISegmentedControl) {
    self.tableView.scrollToRow(
      at: IndexPath(row: 0, section: sender.selectedSegmentIndex), at: .top, animated: true)
  }
