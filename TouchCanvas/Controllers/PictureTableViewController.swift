...
class PictureTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        guard let rawPictureTypes = UserDefaults.standard.value(forKey: "UDRawPictureTypes") as? Data else { return }
...
//            let index = osPictureType["OsPictureType"]["id"].int ?? 10000
        ...
        self.titleSegmentedControl.addTarget(self, action:#selector(segmentSelected(sender:)), for: UIControl.Event.valueChanged)
...
//        {"code":0,"name":"Response Success","message":"Response Success","url":"\/os_raw_pictures.json","data":[{"OsRawPicture":{"id":24,"os_picture_type_id":1,"display_name":"00025849","original_name":"\/uploads\/00025849_043_1.png","width":null,"height":null,"ext":null,"byte":null,"created":"2019-02-11 05:53:22","modified":"2019-02-11 05:53:22"},"OsPictureType":{"id":1,"name":"Chest ... X-ray","code":"CXR","is_polygon_type":true,"is_check_type":false,"is_active":true}}]}
        ...
        AF.request(K.API_SERVER_PREFIX + "os_raw_pictures.json?page=1&os_picture_type_id=" + self.jsonPictureTypes[sender.selectedSegmentIndex]["OsPictureType"]["id"].stringValue).responseJSON {response in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel?.text = self.osAllRawPictures[indexPath.row]["OsRawPicture"]["display_name"].stringValue
        
        let imageUrl = K.API_SERVER_PREFIX + self.osAllRawPictures[indexPath.row]["OsRawPicture"]["original_name"].stringValue
        cell.imageView?.sd_setImage(with: URL(string:imageUrl), placeholderImage: UIImage(named: "default-thumbnail.jpg"),options: SDWebImageOptions(rawValue: 0), completed: { (image, error, cacheType, imageURL) in
            // Perform operation.
        })
        return cell
    }
