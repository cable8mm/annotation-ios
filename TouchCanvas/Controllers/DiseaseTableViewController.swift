...
class DiseaseTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        AF.request(K.API_SERVER_PREFIX + "os_picture_type_diseases.json?os_picture_type_id=" + String(self.pictureTypeId)).responseJSON {response in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel?.text = self.osAllRawLabels[indexPath.row]["OsPictureTypeDisease"]["name"].stringValue
